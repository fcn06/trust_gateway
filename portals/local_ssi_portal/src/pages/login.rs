        ...
        <div class="flex items-center justify-center min-h-screen bg-slate-950">
            <div class="bg-slate-900 p-8 rounded-2xl border border-slate-800 shadow-2xl w-full max-w-md">
                <div class="text-center mb-8">
                    ...
                    <p class="text-slate-400 text-sm">"Secure messaging and AI tools — powered by your own identity."</p>
                    <p class="text-slate-500 text-xs mt-2">"Sign in with your device biometrics. No passwords needed."</p>
                    <div class="border border-amber-500/20 bg-amber-500/5 p-3 rounded-lg text-xs text-amber-400 text-center mt-4 animate-in fade-in duration-300">
                        "⚠️ Sandbox Preview — This is a local testing preview. Accounts created here are ephemeral and may be reset."
                    </div>
                </div>
                <div class="space-y-5">
                    <div>
