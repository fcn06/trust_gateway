...
pub struct ExecutionGrant {
    ...
    /// SHA-256 hash of the canonical JSON arguments (SEC-2: mandatory).
    /// Executors MUST verify this matches the hash of the actual arguments
    /// being executed. Grants without input_hash are rejected at the boundary.
    /// This prevents grant re-targeting and argument tampering.
