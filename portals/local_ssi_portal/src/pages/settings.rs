                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between p-3 bg-slate-900 rounded-lg border border-slate-600">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-white">"OpenMLS"</p>
                    ...
                    <button 
                        on:click=move |_| {
                            if let Some(win) = web_sys::window() {
                                if let Ok(true) = win.confirm_with_message("WARNING: This will permanently delete your organization and all associated profiles, messages, and security policies. This action CANNOT be undone. Are you absolutely sure you want to proceed?") {
                                    log::warn!("Organization deletion requested and confirmed by user.");
                                }
                            }
                        }
                        class="bg-red-600/20 text-red-400 px-4 py-2 rounded-lg hover:bg-red-600/40 transition-colors text-sm font-medium border border-red-600/30"
                    >
                        "Delete"
                    </button>
                </div>
